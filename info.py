...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '-1001814965939').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else [5958870787]
